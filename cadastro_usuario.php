...
<head>
    ...
    <link href="./style/cad-usuario.scss" rel="stylesheet">
        ...
        <div class="container_form">
            <div class="content-table">
                <div class="title-table">
                    ...
                    <button id="btnAdicionarCargo"><img src="./assets/img/adicionar.png" alt="">Adicionar Cargo</button>
                </div>
                <form action="./cad_usuario.php" method="POST" id="cadUsuario">
                    ...
                    <div class="container-button">
                        <button name="salva_funcionario">Salvar</button>
                    </div>
                </form>
            </div>
        </div>
        <div id="app"></div>
        <div class="cadastro-produto" id="cadastroCargo">
