        ...
        <div class="container_form">
            <div class="content-table">
                <div class="title-table">
                    ...
                    <button id="btnAdicionarTipo"><img src="./assets/img/adicionar.png" alt="">Adicionar Tipo</button>
                </div>
                <form action="./salva_fornecedor.php" method="POST" id="cadFornecedor">
                    ...
                    <div class="container-button">
                        <button name="salva_fornecedor">Salvar</button>
                    </div>
                </form>
            </div>
        </div>
        <div id="app"></div>
        <div class="cadastro-produto" id="cadastroTipo">
